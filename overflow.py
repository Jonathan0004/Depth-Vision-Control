...
def update_motor_control(steer_target_px, encoder_px):
    ...
    # During calibration, completely disable PWM so the motor cannot move.
    # Guard here as well (in addition to start/end calibration hooks) to
    # ensure PWM remains off if this function is called while calibrating.
